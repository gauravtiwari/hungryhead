class CommentNotificationCacheService
  ...
  def activity_json
    recipient_name = @activity.recipient_type == "Share" || @activity.recipient_type == "Investment" || @activity.recipient_type == "Feedback" || @activity.recipient_type == "Note"? @activity.recipient.user.name : @activity.recipient.name

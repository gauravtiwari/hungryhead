json.user do
	...
	json.profile do
		...
		json.institution_id @user.institution.id if @user.institution
		json.institution @user.institution.name if @user.institution
		json.institution_url profile_path(@user.institution) if @user.institution

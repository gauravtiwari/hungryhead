...
var LatestIdeaFeed = React.createClass({
  ...
  componentDidMount: function() {
    if(this.isMounted()){
      ...
      var idea_feed_channel = pusher.subscribe(this.props.channel_name);
      if(idea_feed_channel) {
        idea_feed_channel.bind(this.props.channel_event, function(data){
      ...
      <div className="widget-11-2 panel b-b b-light-grey no-margin">
          <div className="panel-heading bg-light-blue-lightest">
            <div className="panel-title">
              <i className="fa fa-list text-danger"></i> Ticker
            </div>
          </div>

var IdeaCardStats = React.createClass({
  ...
  render: function() {
    ...
    return(
        <div className="widget-16 panel p-l-25 p-r-45 p-t-25 bg-white box-shadow m-b-10">
            <div className="row">
            <div style={{width: '50%'}} className="text-center auto-margin">
                <div className="progress-text text-center text-master fs-16 p-b-10 bold">Score: {this.state.score} / 10K <span className="fa fa-question-circle" data-toggle="tooltip" title="Total Validation score"></span></div>
            ...
            <div className="row p-b-25 text-center">
              <div className="inline m-r-15">
                <span className="font-montserrat m-r-5 text-master"><span className="fa fa-eye"></span></span>
                <span className="font-montserrat no-margin text-master">{this.state.views_count}</span>
              </div>

              <div className="inline m-r-15">
                <span className="font-montserrat m-r-5 text-master"><span className="fa fa-comments"></span></span>
                <span className="font-montserrat no-margin text-master">{this.state.feedbacks_count}</span>
              </div>
              <div className="inline m-r-15">
                <span className="font-montserrat m-r-5 text-master"><span className="fa fa-dollar"></span></span>
                <span className="font-montserrat  no-margin text-master ">{this.state.raised}</span>
              </div>
              <div className="inline">
                <span className="font-montserrat m-r-5 text-master"><span className="fa fa-thumbs-up"></span></span>
                <span className="font-montserrat no-margin text-master">{this.state.votes_count}</span>
              </div>
            </div>
          </div>
    )

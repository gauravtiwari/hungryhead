...
var MentorRegister = React.createClass({
  ...
  render: function() {
    return (<MentorRegisterationForm loading={this.state.loading} form={this.state.form} handleRegisterationSubmit={this.handleRegisteration} />);
  }

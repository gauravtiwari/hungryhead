...
var Rate = React.createClass({
  ...
  render: function() {
    ...
    var title = this.state.rate.owner_name + ' earned a ' + this.state.rate.badge_name + ' badge';
      ...
      <div className="badges-list">
        ...
        <div className={badge_classes}>
          ...
          <li className="m-r-10 pull-left no-padding text-center">
            <a className="displayblock" onClick={this.handleClick.bind(this, 6)} data-container="body" data-toggle="tooltip" data-placement="top" title="Helpful">
          ...
          <li className="m-r-10 pull-left no-padding text-center">
            <a className="displayblock" onClick={this.handleClick.bind(this, 7)} data-container="body" data-toggle="tooltip" data-placement="top" title="Not helpful">
          ...
          <li className="m-r-10 pull-left no-padding text-center">
            <a className="displayblock" onClick={this.handleClick.bind(this, 8)} data-container="body" data-toggle="tooltip" data-placement="top" title="OK">
           ...
           <li className="m-r-10 pull-left no-padding text-center">
              <a className="displayblock" onClick={this.handleClick.bind(this, 9)} data-container="body" data-toggle="tooltip" data-placement="top" title="Very Helpful">
            ...
            <li className="pull-left no-padding text-center">
               <a className="displayblock" onClick={this.handleClick.bind(this, 10)} data-container="body" data-toggle="tooltip" data-placement="top" title="Game Changing!">

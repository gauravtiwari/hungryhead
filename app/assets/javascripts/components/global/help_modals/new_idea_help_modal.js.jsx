...
var NewIdeaHelpModal = React.createClass({
  ...
  componentDidMount: function() {
    ...
    $('#idea_help_modal').slimScroll({height: this.state.bodyHeight});
  },

  sizeContent: function() {
    var newHeight = $("html").height() - 100 + "px";
    this.setState({bodyHeight: newHeight.toString()});
    $('#idea_help_modal').slimScroll({destroy: true});
    $("#idea_help_modal").css("height", newHeight,toString());
    $('#idea_help_modal').slimScroll({height: this.state.bodyHeight});
  },
    ...
    return (
        ...
        <div className="modal-content-wrapper">
            <div className="modal-content table-block">
                ...
                <div className="modal-body scrollable" id="idea_help_modal">
                    <div className="row">

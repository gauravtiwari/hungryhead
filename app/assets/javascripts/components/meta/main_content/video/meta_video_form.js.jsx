...
var MetaVideoForm = React.createClass({
    ...
    return (
      <div className={classes}>
         <form id="plan-edit-form" ref="video_form" className="video-edit-form" onSubmit={this._onKeyDown}>
             ...
             <label className="margin-bottom">Add a 3 minute video pitch. <span>Introduce your meta and team.</span></label>
             <input ref="video" className="form-control empty" defaultValue= {this.props.meta.video} name="meta[video]" placeholder='Enter youtube or vimeo url' />

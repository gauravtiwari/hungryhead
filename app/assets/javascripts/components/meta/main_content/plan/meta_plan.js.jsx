...
var MetaPlan = React.createClass({
  ...
  render: function() {
    ...
    var text = this.state.editable ? <span><i className="ion-close"></i> Cancel </span> : <span><i className="ion-edit"></i> Edit plan</span>;
    
    if(this.props.meta.description) {
      var html = converter.makeHtml(this.props.meta.description);
    } else {
      var html = "<div class='no-content'>Describe your meta. <span>What is it? Story? etc.</span> </div>";
    }
      ...
      return (
        <div className="widget-box the-plan">
          ...
          <div className="profile-wrapper-title">
              <h4><i className="ion-search red-link"></i> Idea</h4>
          ...
          <div className="section-content plan">
            ...
            <MetaPlanForm editable={this.state.editable} meta={this.props.meta} loading= {this.state.loading} handlePlanSubmit= {this.handlePlanSubmit} form={this.props.meta} />
          </div>
        </div>
      );
    } else {

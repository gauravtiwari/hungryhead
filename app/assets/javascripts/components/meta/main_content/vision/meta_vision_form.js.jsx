...
var MetaVisionForm = React.createClass({
  ...
  render: function() {
    ...
    if(this.props.meta.sections && this.props.meta.sections.vision) {
      var vision = this.props.meta.sections.vision;
    } else {
      var vision = "";
    }
    ...
    return (
      <div className={classes}>
         <form id="vision-edit-form" ref="vision_form" className="vision-edit-form" onSubmit={this._onKeyDown}>
             ...
             <textarea ref="description" className="form-control empty" defaultValue= {vision} name="meta[vision]" placeholder='What is your vision?' autofocus/>

...
var MetaVision = React.createClass({
  ...
  render: function() {
    ...
    if(this.props.meta.sections && this.props.meta.sections.vision) {
      var html = converter.makeHtml(this.props.meta.sections.vision);
    } else {
      ...
      return (
        <div className="widget-box the-vision">
          ...
          <div className="profile-wrapper-title">
              <h4><i className="ion-earth red-link"></i> Vision</h4>
          ...
          <div className="section-content vision">
            ...
            <MetaVisionForm editable={this.state.editable} meta={this.props.meta} loading= {this.state.loading} handleVisionSubmit= {this.handleVisionSubmit} form={this.props.meta} />
          </div>
        </div>
      )
    } else {

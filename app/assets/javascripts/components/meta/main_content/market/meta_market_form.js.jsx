...
var MetaMarketForm = React.createClass({
  ...
  render: function() {
    ...
    var loading_class = cx({
     ...
     if(this.props.meta.sections && this.props.meta.sections.market) {
      var market = this.props.meta.sections.market;
     } else {
      var market = "";
     }
    ...
    return (
      <div className={classes}>
         <form id="market-edit-form" ref="market_form" className="market-edit-form" onSubmit={this._onKeyDown}>
             ...
             <label className="margin-bottom">Describe the market for your meta. <span>Estimated numbers? Any metrices? etc.</span> You can link images. </label>
             <textarea ref="description" className="form-control empty" defaultValue={market} name="meta[market]" placeholder='Describe your market' autofocus/>

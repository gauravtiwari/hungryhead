...
var MetaProblemsForm = React.createClass({
  ...
  render: function() {
    ...
    if(this.props.meta.sections  && this.props.meta.sections.problems) {
      var problems = this.props.meta.sections.problems;
    } else {
      var problems = "";
    }
    ...
    return (
      <div className={classes}>
         <form id="problems-edit-form" ref="problems_form" className="problems-edit-form" onSubmit={this._onKeyDown}>
             ...
             <textarea ref="description" className="form-control empty" defaultValue= {problems} name="meta[problems]" placeholder='List the problems you have identified?' autofocus/>

...
var MetaSolutionsForm = React.createClass({
  ...
  render: function() {
    ...
    if(this.props.meta.sections && this.props.meta.sections.solutions) {
      var solutions = this.props.meta.sections.solutions;
    } else {
      var solutions = "";
    }
    ...
    return (
      <div className={classes}>
         <form id="solutions-edit-form" ref="solutions_form" className="solutions-edit-form" onSubmit={this._onKeyDown}>
             ...
             <textarea ref="description" className="form-control empty" defaultValue= {solutions} name="meta[solutions]" placeholder='List your solutions' autofocus/>

class User < ActiveRecord::Base
  ...
  :cover_processing, :avatar_processing, :avatar_tmp
  ...
  validates :username, :presence => true, :length => {:within => 5..40}, :uniqueness => true, format: { with: /\A[a-zA-Z0-9-]+\Z/, message: "should not contain empty spaces or symbols" }

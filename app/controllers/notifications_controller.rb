class NotificationsController < ApplicationController
  ...
  def index
    @notifications = current_user.latest_notifications.revrange(0, 100).paginate(:page => params[:page], :per_page => 10)
    render json: Oj.dump(@notifications.uniq.flatten.shuffle, {:mode => :compat})
  end

(function($) {
    ...
    HH.prototype.setUserOS = function() {
        var OSName = "";
    ...
    HH.prototype.setUserAgent = function() {
    ...
    // HH util functions
    HH.prototype.isVisibleXs = function() {
        (!$('#pg-visible-xs').length) && this.$body.append('<div id="pg-visible-xs" class="visible-xs" />');
        return $('#pg-visible-xs').is(':visible');
    }

    HH.prototype.isVisibleSm = function() {
        (!$('#pg-visible-sm').length) && this.$body.append('<div id="pg-visible-sm" class="visible-sm" />');
        return $('#pg-visible-sm').is(':visible');
    }

    HH.prototype.isVisibleMd = function() {
        (!$('#pg-visible-md').length) && this.$body.append('<div id="pg-visible-md" class="visible-md" />');
        return $('#pg-visible-md').is(':visible');
    }

    HH.prototype.isVisibleLg = function() {
        (!$('#pg-visible-lg').length) && this.$body.append('<div id="pg-visible-lg" class="visible-lg" />');
        return $('#pg-visible-lg').is(':visible');
    }

    HH.prototype.getUserAgent = function() {
        return $('body').hasClass('mobile') ? "mobile" : "desktop";
    }

    HH.prototype.setBackgroundImage = function() {
    ...
    HH.prototype.setFullScreen = function(element) {
    ...
    HH.prototype.getColor = function(color, opacity) {
    ...
    // Initialize Layout
    HH.prototype.initSidebar = function() {
    ...
    HH.prototype.initDropDown = function() {
    ...
    HH.prototype.initFormGroupDefault = function() {
    ...
    HH.prototype.initSlidingTabs = function() {
    ...
    HH.prototype.initNotificationCenter = function() {
    ...
    HH.prototype.initProgressBars = function() {
    ...
    HH.prototype.initView = function() {
    ...
    HH.prototype.initInputFile = function() {
    ...
    // Initialize Plugins
    HH.prototype.initTooltipPlugin = function() {
        $.fn.tooltip && $('[data-toggle="tooltip"]').tooltip();
    }

    HH.prototype.initSelect2Plugin = function() {
    ...
    HH.prototype.initScrollBarPlugin = function() {
        $.fn.scrollbar && $('.scrollable').scrollbar({
            ignoreOverlay: false
        });
    }

    HH.prototype.initSelectFxPlugin = function() {
    ...
    HH.prototype.initUnveilPlugin = function() {
        // lazy load retina images
        $.fn.unveil && $("img").unveil();
    }

    HH.prototype.initValidatorPlugin = function() {
...
(function($) {
    ...
    var Parallax = function(element, options) {
        ...
        this.$coverPhoto = this.$element.find('.cover-photo') || this.$element.find('.join-photo') || this.$element.find('.story-photo') || this.$element.find('.join-alumni-photo') || this.$element.find('.how-photo') || this.$element.find('.learn-photo');
 ...
 (function($) {
     ...
     var Sidebar = function(element, options) {
         ...
         ($.HH.getUserAgent() == 'desktop') && this.$sidebarMenu.scrollbar({
             ignoreOverlay: false
         });
         ...
         function sidebarMouseEnter(e) {
             if ($.HH.isVisibleSm() || $.HH.isVisibleXs()) {
                 return false
             }
...
(function($) {
    ...
    (typeof angular === 'undefined') && $.HH.init();
})(window.jQuery);
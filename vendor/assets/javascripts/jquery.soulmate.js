(function() {
  ...
  Suggestion = (function() {
    ...
    Suggestion.prototype.select = function(callback) {
      return callback(this.term, this.data.data, this.type, this.index, this.id);
    };
    ...
    Suggestion.prototype.render = function(callback) {
      ...
      if(this.data.image && this.data.description) {
        return "<li id=\"" + this.id + "\" class=\"soulmate-suggestion\"><div class=\"thumbnail-wrapper d32 circular b-white m-r-10 box-shadow\">" + "<img src=\"" + this.data.image + "\" width=\"30px\" class=\"autocomplete search-image\" />" + "</div><span class=\"autocomplete search-term \">" + (callback(this.term, this.data, this.type, this.index, this.id)) + "</span>" + "\n" + "<p class=\"autocomplete search-description hint-text overflow-hidden \">" + this.data.description + "</p></li>";
      } else if(this.data.image && !this.data.description) {
        return "<li id=\"" + this.id + "\" class=\"soulmate-suggestion\"><div class=\"thumbnail-wrapper d32 circular b-white m-r-10 box-shadow\">" + "<img src=\"" + this.data.image + "\" width=\"30px\"  class=\"autocomplete search-image\" />" + "</div><span class=\"autocomplete search-term \">" + (callback(this.term, this.data, this.type, this.index, this.id)) + "</span>" + "</li>";
        ...
        return "<li id=\"" + this.id + "\" class=\"soulmate-suggestion no-image\"><div class=\"thumbnail-wrapper d32 circular b-white m-r-10 box-shadow\"><span class=\"placeholder bold text-white\">" + badge + "</span></div>" + "<span class=\"autocomplete search-term \">" + (callback(this.term, this.data, this.type, this.index, this.id)) + "</span>" + "</li>";
      }
      ...
      for (type in results) {
        ...
        _results.push((function() {
          ...
          for (_i = 0, _len = typeResults.length; _i < _len; _i++) {
            ...
            this.suggestions.push(new Suggestion(i, result.term, result, type));
            _results2.push(i += 1);
          }
          return _results2;
        }).call(this));
      ...
      if (this.suggestions.length) {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          ...
          if (suggestion.type !== type) {
            ...
            h += this._renderTypeStart(type);
          }
          h += this._renderSuggestion(suggestion);
        }
        h += this._renderTypeEnd();
      }
      return h;
    };

...
CREATE TABLE events (
    ...
    start_time timestamp without time zone DEFAULT '2015-06-26 23:37:38.523385'::timestamp without time zone NOT NULL,
    end_time timestamp without time zone DEFAULT '2015-06-26 23:37:38.52341'::timestamp without time zone NOT NULL,
...
CREATE TABLE schools (
    ...
    slug character varying NOT NULL,
    enquiry_email character varying DEFAULT ''::character varying NOT NULL,
    enquiry_phone character varying DEFAULT ''::character varying NOT NULL,
    ...
    twitter_email character varying DEFAULT ''::character varying NOT NULL,
    media jsonb DEFAULT '{}'::jsonb,
    data jsonb DEFAULT '{}'::jsonb,
    cached_location_list character varying,
    customizations jsonb DEFAULT '{}'::jsonb,

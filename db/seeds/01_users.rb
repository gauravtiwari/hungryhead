...
ActiveRecord::Base.transaction do
  ...
  1.upto(30) { |i|
    ...
    Mentor.create!(
      ...
      username: Forgery::Internet.user_name + SecureRandom.hex(4),
      password: 'password',
      mini_bio: Forgery::LoremIpsum.words(5),
  ...
  1.upto(30) { |i|
    ...
    Teacher.create!(
      ...
      first_name: Forgery::Name.first_name,
      last_name: Forgery::Name.last_name,
      username: Forgery::Internet.user_name + SecureRandom.hex(5),
      password: 'password',
      mini_bio: Forgery::LoremIpsum.words(5),
      school_id: [*1..10].sample,
      location_list: Forgery::Address.city,
  ...
  1.upto(100) { |i|
    ...
    Student.create!(
      ...
      first_name: Forgery::Name.first_name,
      last_name: Forgery::Name.last_name,
      username: Forgery::Internet.user_name + SecureRandom.hex(6),
      password: 'password',
      mini_bio: Forgery::LoremIpsum.words(5),
      school_id: [*1..10].sample,
      location_list: Forgery::Address.city,
